...
const QString PROJECT_WEBSITE_URL{"http://www.geometrize.co.uk"}; ///< The project's dedicated website URL.
...
const QString MORE_RESOURCES_URL{"http://resources.geometrize.co.uk"}; ///< URL to a webpage providing additional templates, scripts and/or helpful links.
